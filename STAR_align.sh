...
helpFunction()
{
  ...
  echo "Version: 2.7.5"
  echo ""
  echo "Usage: ./STAR_align.sh -i <input file or directory> -r <reference trancriptome> -o <output location>[optional] -h <help>"
  echo ""
  echo "Options:"
...
while read sample ; do
  ...
  qsub "${loc}/qsub_star_align.sh" -v sample=${sample},ref=${ref},output=${output},tmp_dir=${tmp_dir},log=${log},star=${star}
done < ${sfile}
